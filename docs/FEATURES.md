...
## 9. Browser Extension — 🔜 (planned)
- **v1 "Job Catcher":** one-click capture of the posting you're viewing on any board (LinkedIn/Indeed/Glassdoor) into your tracker — the legal way to pull walled-garden jobs (the user captures publicly-shown data). No AI.
- **v2 Auto-fill:** fill application forms from your profile + generated docs; never auto-submits.
- **Status:** specced (spec.md US7, FR-022–023); not built.
