...
from app.services.sources.jobicy import JobicySource
...
#: NOTE: keyword-searchable sources (adzuna, jsearch, remotive, jobicy) work in
#: live search; feed sources (themuse, remoteok) have no keyword search and are
#: driven only by scheduled ingestion — see job_search.ingest_curated_jobs.
