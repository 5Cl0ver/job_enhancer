...
SKILLS: list[str] = [
    ...
    # Frontend
    "react", "angular", "vue", "next.js", "svelte", "tailwind", "redux",
    "react native", "responsive design", "accessibility", "figma", "webpack",
    "vite",
    # Backend
    "node.js", "express", "django", "flask", "fastapi", "spring", ".net",
    "rails", "laravel", "graphql", "rest api", "rest apis", "microservices",
    "websocket", "grpc",
    # Data stores
    ...
    "jenkins", "github actions", "linux", "nginx", "serverless", "lambda",
    "devops",
    # Data / AI
    "machine learning", "deep learning", "pytorch", "tensorflow", "pandas",
    "numpy", "data analysis", "data engineering", "nlp", "llm",
    "computer vision", "etl", "spark", "data integration",
    # Practice
    "agile", "scrum", "git", "unit testing", "integration testing", "tdd",
    "code review", "code reviews", "debugging", "oop", "design patterns",
    "data structures", "algorithms", "security", "oauth", "jwt", "sdlc",
    "version control", "troubleshooting", "documentation",
    # Soft
